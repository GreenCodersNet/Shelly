' ###  ShellyAiResponseZoom.vb | v1.0.1 ### 
...
' ##########################################################
Public Class ShellyAiResponseZoom
    Private Sub ShellyAiResponseZoom_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ShellyAiResponseZoom_Shown(sender As Object, e As EventArgs) Handles Me.Shown
